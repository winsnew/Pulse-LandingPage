    ...
    >
        ...
        {pricing.map((item, idx) => {
            ...
            <motion.div
                ...
                className={`w-full max-w-sm p-8 rounded-3xl shadow-lg border border-white/10 backdrop-blur-md bg-white/5 text-white relative overflow-hidden ${
                idx === 1 ? 'border-primary shadow-primary/20' : ''
                }`}
            >
                {idx === 1 && (
                ...
                {currentPrice && (
                    ...
                    <span className="text-5xl font-extrabold leading-none ml-1">{currentPrice}</span>
                    {!isFreePlan && (
